...
You will be prompted to input a number of parameters. Note that {\ttfamily window\+\_\+average} is an integer representing the moving average window that will be used for the time domain averaging, {\ttfamily average\+\_\+mode} is a string which determines the type of averaging that will be applied (the two options are \char`\"{}moving\+\_\+average\char`\"{} and \char`\"{}exponential\+\_\+moving\+\_\+average\char`\"{}), and {\ttfamily num\+\_\+fourier\+\_\+coeffs} represents the number of Fourier coefficients that will be used for the filtering in the Fourier domain (i.\+e. we consider the ones with the largest magnitude for reconstructing the signal in the time domain).
